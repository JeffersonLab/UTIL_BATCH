...
eval "$REPLAYPATH/hcana -l -q \"UTIL_PION/scripts/replay/replay_AllRefTimes.C($RUNNUMBER,$MAXEVENTS)\""

cd $REPLAYPATH/CALIBRATION/ref_times
COMMAND="root -l -q -b RefTimes.C(\"$REPLAYPATH/ROOTfiles/Calib/General/Pion_coin_AllRefTimes_$RUNNUMBER_$MAXEVENTS.root\",$RUNNUMBER)"
echo $COMMAND
#eval $COMMAND
exit 0
